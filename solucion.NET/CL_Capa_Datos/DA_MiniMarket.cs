...
namespace CL_Capa_Datos
{
    public class DA_MiniMarket : DA_BASE
    {
        ...
        {
            string  strSQL = "Insert into minimarket(nit,razonSocial,telefono,nomenclatura,ciudad,departamento,correo" +
        ...
        public static DataTable ConsultartMiniMarket()
        {

            DataTable dt = new DataTable();
            string strSQL = "Select nit,razonSocial,telefono,nomenclatura,ciudad,departamento,correo" +
                ",sitioWeb,facebook,whatsapp from minimarket where idMinimarket = 1;";
